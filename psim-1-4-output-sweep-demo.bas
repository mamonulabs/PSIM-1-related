...
' Description:  Sweeps all four DAC outputs from 0 to 4095 to 0.
' 				Note: Plays tone on AUX jack until STOP is pressed.
...
' Revision Date:  2004/01/26  3:25 AM
'*****************************************************************
...
TEMPO		VAR	BYTE	' TEMPO=1 Is Equal to 0.5ms (Value 0 to 254)
